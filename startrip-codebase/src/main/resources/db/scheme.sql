...
(
    favoriteevent_id uuid not null
        constraint favorite_event_pkey
            primary key,
    created_date timestamp,
    is_executed boolean,
    is_valid boolean,
    updated_date timestamp,
    event_id uuid
        constraint fkgvm3wmrgu3h5biyjt3l8pscuc
            references event,
    user_id bigint
        constraint fkpe3xk96csvs2qowcytotj2hl4
            references "user"
);
